...
type NotificationBancaribe struct {
	...
	Amount               float64   `gorm:"type:decimal(13,2)"`
	BankName             string    `gorm:"size:30"`
	ClientPhone          string    `gorm:"size:16"`
	CommercePhone        string    `gorm:"size:16"`
	CreditorAccount      string    `gorm:"size:50"`
	CurrencyCode         string    `gorm:"size:5"`
	DateBancaribe        string    `gorm:"size:12"`
	...
	TimeBancaribe        string    `gorm:"size:10"`
